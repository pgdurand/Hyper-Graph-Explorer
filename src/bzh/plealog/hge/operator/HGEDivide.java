 ...
 * 
 * */
public class HGEDivide extends HGEOperator {

  private static final String ERROR = "'divide' operation is made on non-numerical values.";
  private static final HGEOperatorException OPEXCEPTION = new HGEOperatorException(ERROR);

  private static final String ERROR_CT = "'divide' operation is made on non-atomic values.";
