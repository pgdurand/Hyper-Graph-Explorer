...
public class HGEMatch extends HGEOperator {
  ...
  private static final HGEOperatorException NOTREGEXPXCEPTION = 
      new HGEOperatorException("Argument is not a regular expression");
  ...
  public void interpret(HGEExecutionContext context, HGEStack stack){
    ...
    if (arg1 instanceof HGEString){
      matcher = (HGEString) arg1;
      //System.out.println("RegExp: "+arg1.stringValue());
    }
    else{
      throw NOTREGEXPXCEPTION;
    }
