 ...
 * Multiply operator.
 * */
public class HGEMultiply extends HGEOperator {

  private static final String ERROR = "'multiply' operation is made on non-numerical values.";
  private static final HGEOperatorException OPEXCEPTION = new HGEOperatorException(ERROR);

  private static final String ERROR_CT = "'multiply' operation is made on non-atomic values.";
  ...
  public void interpret(HGEExecutionContext context, HGEStack stack){
    ...
    if (type1==DGMAttribute.DT_LONG && type2==DGMAttribute.DT_LONG){
      ...
      result.setDoubleValue(arg1.doubleValue()*arg2.doubleValue());
      stack.push(result);
    }
    arg1.setInUse(false);
    arg2.setInUse(false);
