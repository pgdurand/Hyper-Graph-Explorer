 ...
 * 
 * */
public class HGEAdd extends HGEOperator {

  private static final String ERROR = "'add' operation is made on non-numerical values.";
  private static final HGEOperatorException OPEXCEPTION = new HGEOperatorException(ERROR);

  private static final String ERROR_CT = "'add' operation is made on non-atomic values.";
