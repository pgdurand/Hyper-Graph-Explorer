 ...
 */
public class HGEBooleanAnd extends HGEOperator {

  private static final String ERROR = "'and' operation is made on non-boolean values.";
  private static final HGEOperatorException OPEXCEPTION = new HGEOperatorException(ERROR);

  private static final String ERROR_CT = "'and' operation is made on non-atomic values.";
  private static final HGEOperatorException OPEXCEPTION_CT = new HGEOperatorException(ERROR_CT);

  /**
   * Constructor.
   **/
  public HGEBooleanAnd(){
    setName("and");
  }
