 ...
 * */
public class AddDoubleFunc extends AbstractFunction {
  private static final int ARG_DATA_TYPES[]={DGMAttribute.DT_DOUBLE, DGMAttribute.DT_DOUBLE};
