 ...
 *
 */
public class HGELessThanEqualTest extends TestCase {
    private HGEDouble           d1, d2;
    private HGELong             l1, l2;
    private HGEStack            stack;
    private HGELessThanEqual    relOpe;
    private HGEExecutionContext context;
    
	public HGELessThanEqualTest(String name){
        super(name);
    }
	...
	protected void setUp() {
        ...
        relOpe=new HGELessThanEqual();
	}

    public static Test suite() {
        TestSuite ts = new TestSuite();
        ts.addTest(new HGELessThanEqualTest("testDoubleLTE"));
        ts.addTest(new HGELessThanEqualTest("testLongLTE"));
        ts.addTest(new HGELessThanEqualTest("testDoubleLongLTE"));
        return (ts);
	}
