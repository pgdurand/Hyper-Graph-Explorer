 ...
 *
 */
public class HGEMultiplyTest extends TestCase {
    private HGEDouble           d1, d2;
    private HGELong             l1, l2;
    private HGEStack            stack;
    private HGEMultiply         adder;
    private HGEExecutionContext context;
    
	public HGEMultiplyTest(String name){
        super(name);
    }
	...
	protected void setUp() {
        ...
        adder=new HGEMultiply();
	}

    public static Test suite() {
        TestSuite ts = new TestSuite();
        ts.addTest(new HGEMultiplyTest("testDoubleMult"));
        ts.addTest(new HGEMultiplyTest("testLongMult"));
        ts.addTest(new HGEMultiplyTest("testDoubleLongMult"));
        return (ts);
	}
    ...
    public void testDoubleMult() {
        ...
        assertTrue(result.doubleValue()==30.0);
        assertTrue(stack.size()==0);
    ...
    public void testLongMult() {
        ...
        assertTrue(result.longValue()==30);
        assertTrue(stack.size()==0);
        assertTrue(result.isInUse()==true);
    ...
    public void testDoubleLongMult() {
        HGEValue              result;
