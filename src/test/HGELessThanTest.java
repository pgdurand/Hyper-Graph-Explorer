 ...
 *
 */
public class HGELessThanTest extends TestCase {
    private HGEDouble           d1, d2;
    private HGELong             l1, l2;
    private HGEStack            stack;
    private HGELessThan         relOpe;
    private HGEExecutionContext context;
    
	public HGELessThanTest(String name){
        super(name);
    }
	...
	protected void setUp() {
        ...
        relOpe=new HGELessThan();
	}

    public static Test suite() {
        TestSuite ts = new TestSuite();
        ts.addTest(new HGELessThanTest("testDoubleLT"));
        ts.addTest(new HGELessThanTest("testLongLT"));
        ts.addTest(new HGELessThanTest("testDoubleLongLT"));
        return (ts);
	}
