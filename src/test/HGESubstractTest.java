 ...
 *
 */
public class HGESubstractTest extends TestCase {
    private HGEDouble           d1, d2;
    private HGELong             l1, l2;
    private HGEStack            stack;
    private HGESubtract        adder;
    private HGEExecutionContext context;
    
	public HGESubstractTest(String name){
        super(name);
    }
	...
	protected void setUp() {
        ...
        adder=new HGESubtract();
	}

    public static Test suite() {
        TestSuite ts = new TestSuite();
        ts.addTest(new HGESubstractTest("testDoubleSubs"));
        ts.addTest(new HGESubstractTest("testLongSubs"));
        ts.addTest(new HGESubstractTest("testDoubleLongSubs"));
        return (ts);
	}
    ...
    public void testDoubleLongSubs() {
        HGEValue              result;
