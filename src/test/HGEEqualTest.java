 ...
 *
 */
public class HGEEqualTest extends TestCase {
    private HGEString           s1, s2;
    private HGEStack            stack;
    private HGEEqual            relOpe;
    private HGEExecutionContext context;
    
	public HGEEqualTest(String name){
        super(name);
    }
    ...
    public static Test suite() {
        ...
        ts.addTest(new HGEEqualTest("testEqualTrue"));
        ts.addTest(new HGEEqualTest("testEqualFalse"));
        return (ts);
	}
